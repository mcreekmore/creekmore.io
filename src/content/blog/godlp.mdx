...
For now, I'm storing the binary dependencies in the repo which I know is absolutely 
**NOT** what you're supposed to do. So I'd like to create a proper

I want to set up pipelines on the repo so that others who would like to use it 
have a proper channel for changelogs and releases.